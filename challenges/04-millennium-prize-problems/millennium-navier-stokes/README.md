...
**AutoLab hill:** [`ottogin/millennium-navier-stokes`](https://app.autolab.ai/hills/ottogin/millennium-navier-stokes)  
...
This file formalizes the Clay Mathematics Institute millennium problem concerning the existence and smoothness of solutions to the Navier-Stokes equations in three spatial dimensions. While the definitions are…
...
- Hill page: https://app.autolab.ai/hills/ottogin/millennium-navier-stokes
