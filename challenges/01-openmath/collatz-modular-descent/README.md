...
**AutoLab hill:** [`alejandrozu/collatz-modular-descent`](https://app.autolab.ai/hills/alejandrozu/collatz-modular-descent)  
...
1. `coverage_ppm` — **maximise**
2. `min_descent_ppm` — **maximise**
3. `rule_count` — **minimise**
...
- Hill page: https://app.autolab.ai/hills/alejandrozu/collatz-modular-descent
