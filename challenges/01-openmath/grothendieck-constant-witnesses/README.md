...
**AutoLab hill:** [`alejandrozu/grothendieck-constant-witnesses`](https://app.autolab.ai/hills/alejandrozu/grothendieck-constant-witnesses)  
...
1. `gap_ppm` — **maximise**
2. `matrix_area` — **minimise**
3. `certificate_bits` — **minimise**
...
- Hill page: https://app.autolab.ai/hills/alejandrozu/grothendieck-constant-witnesses
