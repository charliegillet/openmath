...
**AutoLab hill:** [`ottogin/erdos-22`](https://app.autolab.ai/hills/ottogin/erdos-22)  
**List:** Erdős Problems  
**Version:** 0.1.0  
**Visibility:** public
...
The central problem of Ramsey–Turán theory: writing $\mathrm{rt}(n; k, \ell)$ for the maximum number of edges of a $K_k$-free graph on $n$ vertices whose largest independent set has size less than $\ell$, is it true…
...
- Hill page: https://app.autolab.ai/hills/ottogin/erdos-22
